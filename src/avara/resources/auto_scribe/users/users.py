...
from ....types.auto_scribe.user_revoke_access_response import UserRevokeAccessResponse
...
class UsersResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/v1/autoScribe/users/{user_id}", user_id=user_id),
    ...
    def list(
        self,
        *,
        can_create_reports: Optional[bool] | Omit = omit,
